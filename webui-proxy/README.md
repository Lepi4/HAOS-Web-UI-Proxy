...
Аддон автоматически сохраняет список устройств в /share/webui-proxy.json. При переустановке, если настройки пустые, адреса будут восстановлены из этого файла.
